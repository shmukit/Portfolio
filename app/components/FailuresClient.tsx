...
import { renderParagraphOrBullets } from '../../lib/utils/renderParagraphOrBullets';
                      ...
                      <div className="space-y-4">
                        ...
                        {selectedFailure.task && (
                          <div>
                            ...
                            {renderParagraphOrBullets(selectedFailure.task, theme, 'simple')}
                          </div>
                        )}
                        ...
                        {selectedFailure.result && (
                          <div>
                            ...
                            {renderParagraphOrBullets(selectedFailure.result, theme, 'simple')}
                          </div>
                        )}
                      </div>
                    </div>
